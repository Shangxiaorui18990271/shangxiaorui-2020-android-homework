...
import com.example.homework07.adapter.ImagePagerAdapter;
import com.example.homework07.bean.GoodsInfo;

import java.util.ArrayList;

public abstract class ViewPagerActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //在翻页过程中触发。该方法的三个参数取值说明为 ：第一个参数表示当前页面的序号
        ...
        public void onPageSelected(int arg0){
            Toast.makeText( this,"您翻到的商品信息是："+goodsList.get(arg0).name,
